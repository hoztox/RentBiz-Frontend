...
const DeleteChargesModal = ({ isOpen, onCancel, onDelete }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white shadow-lg charges-modal-box">
        <div className="p-3">
          <div className="flex justify-center">
            <div className="charges-modal-bg">
              <img src={deleteImage} alt="Delete" className="h-40" />
            </div>
          </div>

          <div className="text-center mb-6 charges-modal-content">
          ...
          <div className="flex gap-3">
            <button
              onClick={onCancel}
              className="flex-1 text-[#201D1E] hover:bg-gray-100 focus:outline-none charges-cancel-btn"
            >
              Cancel
            </button>
            ...
            <button
              onClick={onDelete}
              className="flex-1 bg-[#E44747] text-white hover:bg-[#d12f2f] focus:outline-none charges-modal-delete-btn"
            >
              Delete
            </button>
          </div>
