...
const UnitType = () => {
  ...
  const demoData = [
    { id: "01", entriDate: "09 Sept 2024", name: "Apartment" },
    { id: "02", entriDate: "09 Sept 2024", name: "Shop" },
    { id: "03", entriDate: "09 Sept 2024", name: "Apartment" },
    { id: "04", entriDate: "09 Sept 2024", name: "Apartment" },
    { id: "05", entriDate: "09 Sept 2024", name: "Shop" },
    { id: "06", entriDate: "09 Sept 2024", name: "Apartment" },
    { id: "07", entriDate: "09 Sept 2024", name: "Apartment" },
    { id: "08", entriDate: "09 Sept 2024", name: "Shop" },
    { id: "09", entriDate: "09 Sept 2024", name: "Apartment" },
    { id: "10", entriDate: "09 Sept 2024", name: "Shop" },
  ];

  const filteredData = demoData.filter(
    (unit) =>
      unit.entriDate.toLowerCase().includes(searchTerm.toLowerCase()) ||
  ...
  return (
    <div className="border border-gray-200 rounded-md unit-table">
            ...
            <div className="bg-[#F0F8FF] p-5 mt-4 rounded-md">
              <div className="flex items-center gap-4">
                <div className="w-1/3">
                  ...
                  <p className="text-[#1458A2] shop-card-num mt-2">20</p>
                </div>
                <div className="w-1/3">
                  <div className="bg-[#F0F8FF] border border-gray-300 rounded-md p-4">
                    <p className="text-[#201D1E] unit-card-text-2">Occupied</p>
                    <p className="text-[#64A2E7] unit-card-num-2 mt-2">15</p>
                  </div>
                </div>
                <div className="w-1/3">
                  <div className="bg-[#F0F8FF] border border-gray-300 p-3 rounded-md">
                    <p className="text-[#201D1E] unit-card-text-2">Vacant</p>
                    <p className="text-[#68C68D] unit-card-num-2 mt-2">05</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* Pagination */}
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center p-3 md:px-5 utype-pagination-container">
