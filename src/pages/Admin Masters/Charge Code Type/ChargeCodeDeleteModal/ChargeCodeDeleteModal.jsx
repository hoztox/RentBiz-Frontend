...
import "./ChargeCodeDeleteModal.css";
import deleteImage from "../../../../assets/Images/Admin Masters/delete-modal-img.png";

const ChargeCodeDeleteModal = ({ isOpen, onCancel, onDelete }) => {
        ...
        <div className="p-6">
          ...
          <div className="text-center mb-6 modal-content">
            ...
            <p className="text-gray-600 text-sm">
              Are you sure you want to delete this charge code?
            </p>
          </div>
...
export default ChargeCodeDeleteModal;
