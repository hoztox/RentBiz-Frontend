...
import editicon from "../../assets/Images/Monthly Invoice/edit-icon.svg";
  ...
  return (
    <div className="border border-[#E9E9E9] rounded-md">
      <div className="flex justify-between items-center p-5 border-b border-[#E9E9E9]">
        <h1 className="monthly-invoice-head">Invoice List</h1>
        <div className="flex gap-[10px]">
          <input
            ...
            className="px-[14px] py-[7px] outline-none border border-[#201D1E20] rounded-md w-[302px] focus:border-gray-300 duration-200 monthly-invoice-search"
          />
          ...
          <div className="relative">
            <select
              name="select"
              id=""
              className="appearance-none px-[14px] py-[7px] border border-[#201D1E20] bg-transparent rounded-md w-[121px] cursor-pointer focus:border-gray-300 duration-200 monthly-invoice-selection"
          ...
          <button className="flex items-center justify-center gap-2 w-[176px] h-[38px] rounded-md add-btn duration-200" onClick={openAddModal}>
            Add New Invoice
      ...
      <table className="w-full border-collapse">
        <thead>
          <tr className="border-b border-[#E9E9E9] h-[57px]">
            <th className="px-5 text-left monthly-invoice-thead">ID</th>
            <th className="px-5 text-left monthly-invoice-thead">DATE</th>
            <th className="pl-5 text-left monthly-invoice-thead">TENANCY ID</th>
            <th className="pl-5 text-left monthly-invoice-thead">TENANT NAME</th>
            <th className="px-5 text-left monthly-invoice-thead w-[10%]">AMOUNT DUE</th>

            <th className="pl-12 pr-5 text-center monthly-invoice-thead">VIEW</th>
            <th className="px-5 pr-6 text-right monthly-invoice-thead">ACTION</th>
          </tr>
        </thead>
        <tbody>
          {paginatedData.map((invoice, index) => (
            ...
            >
              <td className="px-5 text-left monthly-invoice-data">{invoice.id}</td>
              <td className="px-5 text-left monthly-invoice-data">{invoice.date}</td>
              <td className="pl-5 text-left monthly-invoice-data">
                {invoice.tenancyId}
              </td>
              <td className="pl-5 text-left monthly-invoice-data">
                {invoice.tenantName}
              </td>
              <td className="px-5 text-left monthly-invoice-data">
                {invoice.amountDue}
              </td>
              ...
              <td className="px-5 flex gap-[23px] items-center justify-end h-[57px]">
                ...
                <button>
                  <img
                    src={deleteicon}
                    alt="Delete"
                    className="w-[18px] h-[18px] action-btn mr-[22px] duration-200"
                  />
                </button>
              </td>
            </tr>
