...
import bgimg from "../../../../assets/Images/Admin Units/modal-bg-img.svg";
import arrow from "../../../../assets/Images/Admin Units/timeline-arrow.svg";
import "./formtimeline.css";

const steps = [
  { id: 1, name: "Select Building", key: "selectBuilding" },
  { id: 2, name: "Create Unit", key: "createUnit" },
  { id: 3, name: "Upload Documents", key: "uploadDocuments" },
  { id: 4, name: "Review", key: "review" },
  { id: 5, name: "Submitted", key: "submitted" },
];

const FromTimeline = ({ currentStep }) => {
  return (
    <div className="w-[350px] h-full bg-[#1458A2] text-white relative flex flex-col justify-start rounded-md">
      <div className="mt-[60px]">
        {steps.map((step) => (
          <div
            key={step.id}
            className="relative flex justify-between items-center mb-9 px-[34px]"
          >
            ...
            <div className="flex items-center">
              <div
                ...
                ${
                  currentStep >= step.id
                    ? "bg-white text-[#1458A2] scale-110"
                    : "border border-[#64A2E7] text-[#64A2E7]"
                }`}
              >
                {step.id}
              </div>
            ...
            <div
              className={`arrow-container transition-opacity duration-500 ease-in-out ${
