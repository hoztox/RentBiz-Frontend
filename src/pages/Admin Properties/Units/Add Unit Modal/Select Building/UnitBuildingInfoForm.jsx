...
const UnitBuildingInfoForm = ({ onNext }) => {
  ...
  const handleSubmit = (e) => {
    ...
    // Update completedSteps in localStorage to mark "Select Building" (id: 1) as completed
    const completedSteps = JSON.parse(localStorage.getItem("unit_completedSteps")) || [];
...
export default UnitBuildingInfoForm;