...
const EditUnitModal = ({ open, onClose, unitId }) => {
  ...
  const getCurrentStepTitle = () => {
    return (
      steps.find((step) => step.id === currentStep)?.title || "Select Building"
    );
  };
  ...
  if (
    !open ||
    modalState.type !== "edit-unit" ||
    modalState.data?.unitId !== unitId
  ) {
    return null;
  }
