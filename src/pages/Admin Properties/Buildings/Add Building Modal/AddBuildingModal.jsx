    ...
    return (
        ...
        >
            <div
                ...
                className={`max-[480px]:relative building-modal-styles transition-all
                ${open ? "scale-100 opacity-100" : "scale-125 opacity-0"}`}
            >
                {/* Mobile Image */}
                <div className='min-[480px]:hidden w-full h-[117px] bg-[#1458A2] flex justify-center relative'>
                    <img src={buildingimg} alt="Building Top" className='top-[17px] absolute w-[85%]' />
                </div>

                {/* Mobile Header Bar */}
                <div
                    className="min-[480px]:hidden bg-white w-full h-[54px] mx-[16px] rounded-md absolute max-w-[calc(100vw-32px)] top-[88px] p-3 shadow-[0_4px_6px_-1px_rgba(0,0,0,0.1)] flex items-center justify-between cursor-pointer z-10"
