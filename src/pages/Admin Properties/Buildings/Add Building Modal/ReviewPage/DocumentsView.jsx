...
import { ChevronLeft, ChevronRight, File, FileText, Image } from 'lucide-react';
import img1 from "../../../../../assets/Images/Admin Buildings/img1.jpg"
import img2 from "../../../../../assets/Images/Admin Buildings/img2.jpg"
import img3 from "../../../../../assets/Images/Admin Buildings/img3.jpg"
import img4 from "../../../../../assets/Images/Admin Buildings/img4.jpg"
import img5 from "../../../../../assets/Images/Admin Buildings/img5.jpg"
...
const DocumentsView = ({ documents = [] }) => {
    ...
    const visibleDocuments = documents.slice(startIndex, startIndex + documentsPerPage);
...
const DemoComponent = () => {
    ...
    return (
        <div className="pt-5">
            <DocumentsView documents={sampleDocuments} />
