    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white rounded-md w-[1006px] shadow-lg p-1">
        <div className="flex justify-between items-center p-6 mt-2">
          <h2 className="text-[#201D1E] add-collection-head">
            Create New Collection
          </h2>
          <button
            onClick={onClose}
            className="add-collection-close-btn hover:bg-gray-100 duration-200"
          >
        ...
        <div className="p-6 mt-[-15px]">
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              <label className="block add-collection-label">
                Select Tenancy
              </label>
              <div className="relative">
                <select
                  ...
                  className={`block w-full pl-3 pr-10 py-2 border border-gray-200 appearance-none focus:outline-none focus:ring-gray-500 focus:border-gray-500 add-collection-selection ${
                    form.selectTenancy === "" ? "add-collection-selected" : ""
                  }`}
                >
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                className="block w-full px-3 py-2 border border-gray-200 focus:outline-none focus:ring-gray-500 focus:border-gray-500 add-collection-input"
              />
            </div>

            {/* Second row */}
            <div className="space-y-2">
              <label className="block add-collection-label">Unit Name*</label>
              <div className="relative">
                <input
                  type="text"
                  value={form.unitName}
            ...
            <div className="space-y-2">
              <label className="block add-collection-label">End Date</label>
              <div className="relative">
                <input
                  type="text"
                  value={form.endDate}
              ...
              <div className="relative">
                <select
                  ...
                  onChange={(e) => {
                    ...
                    // Add or remove a class based on the value
                    if (e.target.value === "") {
                      e.target.classList.add("add-collection-selected");
                    } else {
                      e.target.classList.remove("add-collection-selected");
                    }
                  }}
                  onFocus={() => setIsSelectOpenStatus(true)}
                  onBlur={() => setIsSelectOpenStatus(false)}
                  className={`block w-full pl-3 pr-10 py-2 border border-gray-200 appearance-none focus:outline-none focus:ring-gray-500 focus:border-gray-500 add-collection-selection ${
                    form.paymentMethod === "" ? "add-collection-selected" : ""
                  }`}
                >
                  <option value="" disabled hidden>
                    Choose
            ...
            <div className="space-y-2 mb-1">
              <label className="block add-collection-label">Remarks</label>
              <input
                type="text"
                value={form.remarks}
            ...
            <div className="flex items-end justify-end mb-1">
              <button
                type="button"
                onClick={handleSave}
                className="bg-[#2892CE] text-white add-collection-save-btn duration-200"
              >
                Save
              </button>
            </div>
