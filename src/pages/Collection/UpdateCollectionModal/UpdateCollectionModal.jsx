    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white rounded-md w-[1006px] shadow-lg p-1">
        <div className="flex justify-between items-center p-6 mt-2">
          <h2 className="text-[#201D1E] update-collection-head">
            Update Collection
          </h2>
          <button
            onClick={onClose}
            className="update-collection-close-btn hover:bg-gray-100 duration-200"
          >
        ...
        <div className="p-6 mt-[-15px]">
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              <label className="block update-collection-label">
                Select Tenancy
              </label>
              <div className="relative">
                <select
                  ...
                  onChange={(e) => {
                    ...
                    if (e.target.value === "") {
                      e.target.classList.update("update-collection-selected");
                    } else {
                      e.target.classList.remove("update-collection-selected");
                    }
                  }}
                  onFocus={() => setIsSelectOpenTenancy(true)}
                  onBlur={() => setIsSelectOpenTenancy(false)}
                  className={`block w-full pl-3 pr-10 py-2 border border-gray-200 appearance-none focus:outline-none focus:ring-gray-500 focus:border-gray-500 update-collection-selection ${
                    form.selectTenancy === "" ? "update-collection-selected" : ""
                  }`}
                >
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                className="block w-full px-3 py-2 border border-gray-200 focus:outline-none focus:ring-gray-500 focus:border-gray-500 update-collection-input"
              />
            </div>

            {/* Second row */}
            <div className="space-y-2">
              <label className="block update-collection-label">Unit Name*</label>
              <div className="relative">
                <input
                  type="text"
                  value={form.unitName}
            ...
            <div className="space-y-2">
              <label className="block update-collection-label">End Date</label>
              <div className="relative">
                <input
                  type="text"
                  value={form.endDate}
                ...
                <table className="w-full border-collapse">
                  <thead>
                    <tr className="border-b border-[#E9E9E9] h-[57px]">
                      <th className="px-[10px] text-left collection-modal-thead uppercase w-[117px]">
                        Charge Type
                      </th>
                      <th className="px-[10px] text-left collection-modal-thead uppercase w-[132px]">
                        Description
                      </th>
                      <th className="px-[10px] text-left collection-modal-thead uppercase w-[137px]">
                        Date
                      </th>
                      <th className="px-[10px] text-left collection-modal-thead uppercase w-[117px]">
                        Amount
                      </th>
                      <th className="px-[10px] text-left collection-modal-thead uppercase w-[42px]">
                        VAT
                      </th>
                      <th className="px-[10px] text-left collection-modal-thead uppercase w-[50px]">
                        Total
                      </th>
                      <th className="px-[10px] text-left collection-modal-thead uppercase w-[66px]">
                        Balance
                      </th>
                      <th className="px-[10px] text-left collection-modal-thead uppercase w-[118px]">
                        Amount Paid
                      </th>
                      <th className="px-[10px] text-left collection-modal-thead uppercase w-[43px]">
                        Total
                      </th>
                    </tr>
                  </thead>
                      ...
                      <tr key={index} className="h-[57px]">
                        ...
                        <td className="px-[5px] py-[5px] w-[116px] relative">
                          <select
                            ...
                            className="w-full h-[38px] border text-gray-700 appearance-none focus:outline-none focus:ring-gray-500 focus:border-gray-500 bg-white collection-modal-table-select"
                          >
                        ...
                        <td className="px-[5px] py-[5px] w-[150px]">
                          <input
                            ...
                            className="w-full h-[38px] border placeholder-[#b7b5be] focus:outline-none focus:ring-gray-500 focus:border-gray-500 collection-modal-table-input"
                          />
                        </td>
                        ...
                        {/* TOTAL */}
                        <td className="px-[5px] py-[5px] w-[44px] text-left text-[14px] font-normal test-[#201D1E]">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <select
                  ...
                  className={`block w-full pl-3 pr-10 py-2 border border-gray-200 appearance-none focus:outline-none focus:ring-gray-500 focus:border-gray-500 update-collection-selection ${
                    form.paymentMethod === "" ? "update-collection-selected" : ""
                  }`}
                >
                  <option value="" disabled hidden>
                    Choose
            ...
            <div className="space-y-2 mb-1">
              <label className="block update-collection-label">Remarks</label>
              <input
                type="text"
                value={form.remarks}
