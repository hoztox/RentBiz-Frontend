...
const TenantDocumentFormResponsive = () => {
  ...
  const handleConfirmModal = () => {
    ...
    // Update tenant_completedSteps to include "Upload Documents" (id: 2) and "Submitted" (id: 3)
    ...
    localStorage.setItem("tenant_activeCard", "null"); // No active card after submission
    navigate("/admin/tenant-reset"); // Navigate to TenantsReset
  };
          ...
          <div className="pt-6">
            <div className="grid grid-cols-2 gap-4 mb-[80px]">
              <button
                ...
                onClick={() => navigate("/admin/tenant-timeline")}
              >
                Back
              </button>
              <button
...
export default TenantDocumentFormResponsive;
