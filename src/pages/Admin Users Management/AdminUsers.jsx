      ...
      <div className="flex justify-between items-center p-5 border-b border-[#E9E9E9]">
        ...
        <div className="flex gap-[10px]">
          <input
            ...
            className="px-[14px] py-[7px] outline-none border border-[#201D1E20] rounded-md w-[302px] focus:border-gray-300 duration-200 user-search"
          />
          ...
          <div className="relative">
            <select
              name="select"
              id=""
              className="appearance-none px-[14px] py-[7px] border border-[#201D1E20] bg-transparent rounded-md w-[121px] cursor-pointer focus:border-gray-300 duration-200 user-selection"
          ...
          <button
            className="flex items-center justify-center gap-2 w-[176px] h-[38px] rounded-md create-user duration-200"
            onClick={openModal}
          >
            Create User
      ...
      <table className="w-full border-collapse">
        <thead>
          <tr className="border-b border-[#E9E9E9] h-[57px]">
            ...
            <th className="px-5 text-left user-thead w-[12%]">CREATED DATE</th>
