        ...
        <div className="border border-[#E9E9E9] rounded-md p-6 mb-6 mt-[-28px] md:mt-[28px]">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="pr-0 md:pr-4 border-r-0 md:border-r border-[#E9E9E9]">
              ...
              <div className="tenancy-view-modal-data">{tenancyData.tenant?.tenant_name || tenancyData.tenant?.name || "N/A"}</div>

              <div className="tenancy-view-modal-label mb-1 mt-4">Unit</div>
              <div className="tenancy-view-modal-data">{tenancyData.unit?.unit_name || tenancyData.unit?.name || "N/A"}</div>
            ...
            <div className="pl-0 md:pl-4">
              ...
              <div className="tenancy-view-modal-data">{tenancyData.building?.building_name || tenancyData.building?.name || "N/A"}</div>
              ...
              <div className="tenancy-view-modal-data">{tenancyData.commision || tenancyData.commision || "N/A"}</div>
            </div>
          </div>
        </div>
              ...
              <>
                ...
                <div className="mobile-table">
                  {tenancyData.additional_charges.map((charge, index) => (
                    ...
                    >
                      <div
                        className={`flex justify-between border-b border-[#E9E9E9] h-[57px] rounded-t ${expandedStates[charge.id || index] ? "bg-[#F2F2F2]" : "bg-white"
                          }`}
                      >
                      ...
                      <div
                        className={`flex justify-between h-[57px] cursor-pointer ${expandedStates[charge.id || index] ? "border-b border-[#E9E9E9]" : ""
                          }`}
