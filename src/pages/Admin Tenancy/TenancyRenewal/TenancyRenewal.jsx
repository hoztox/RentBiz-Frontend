          ...
          <tbody>
            {paginatedData.map((tenancy) => (
              <React.Fragment key={tenancy.id}>
                ...
                >
                  <td className="px-5 text-left tenancy-data">{tenancy.id}</td>
                  <td className="px-3 text-left tenancy-data end-date-column">
                    {tenancy.endDate}
                  </td>
                    ...
                    <td colSpan={3} className="px-5">
                      <div className="tenancy-dropdown-content mb-[16px]">
                        ...
                        <div className="grid grid-cols-3 gap-9">
                          <div>
                            <div className="dropdown-label">RENEW</div>
                            <div className="dropdown-value !text-[#1458a2]">{tenancy.renew}</div>
                          </div>
